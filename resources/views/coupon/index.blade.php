...
@foreach($coupons as $coupon)
  <div class="col-sm-4">
    <div class="card" style="width: 18rem; margin-bottom:25px;">
      <div class="card-body">
      <img class="card-img-top" src="/images/cupom.png" alt="Card image" style="width:100%">
      ...
      <a href="{{ route('coupons.show', $coupon->id) }}" class="btn btn-primary stretched-link">Ver Cupom</a>
      </div>
    </div>
  </div>
